...
<center>
<div id="formwrapper">
<form action="formcari" method="post">
<fieldset>
<h2 align="center">PENCARIAN MAKLUMAT PEMOHON</h2>
<table width="330" border="0" align="center" cellpadding="0">
</td>
</tr>
<tr> <td> <label for="nama">No. Kad Pengenalan:</label> </td>
<td> <input type="text" name="nokadpengenalan"> </td>
</tr>
<td></td>
<td><!-- Button -->
<input class="btn" name="cari" type="button" value="Cari" />
</td>
