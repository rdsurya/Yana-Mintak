...
<fieldset>
<h2 align="center">A. MAKLUMAT PEMOHON</h2>
<!-- nama -->
...
<textarea name="textarea" cols="40" rows="7" required></textarea>

<label for="poskod">*Poskod:</label>
<input type="number" name="poskod" required>
...
<input name="umur" type="text" required />

<!-- tempat lahir -->
<label for="lahir">*5. Tempat Lahir:</label>
<input name="lahir" type="text" required />
...
<p><b>Sila sertakan Lampiran G sekiranya anda bekerja Kerajaan</b></p>
...
<input name="pendapatan" type="text" required />
...
<input name="lhr" type="text" required />

<!-- No. Telefon -->
<label for="tel">*14. No. Telefon:</label>
<input name="tel" type="text" required/>

<!-- Email -->
<label for="email">15. Email:</label>
<input name="email" type="text" />

<!-- Status -->
<label for="status">16. Taraf Perkahwinan:</label>
<select name="status">
...
<p><b>Sekiranya bujang, sila teruskan ke</b></p><a href="tanah.php"><p><b>Bahagian C</b></p></a><br />
<p><b>* - Sila pastikan semua medan wajib diisi. </b></p>

<!-- Button -->
<input class="btn" name="Simpan" type="button" value="Simpan" />
<a href="pasangan.php"><input class="btn" name="Seterusnya" type="button" value="Seterusnya" /></a>
</fieldset>
</form>
